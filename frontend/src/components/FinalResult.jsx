...
const markDownComponent = {
  ...
  p: ({ children }) => (
    <p className="leading-relaxed mb-3 text-gray-700">{children}</p>
  ),
  ul: ({ children }) => (
    ...
    <div className="mt-6 p-3 space-y-10 bg-white">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div className="flex gap-3 flex-wrap">
          ...
          <button onClick={() => downloadPpt(result)} className="px-4 py-2 rounded-lg text-sm font-medium bg-indigo-600 text-white hover:bg-indigo-700">
            📊 Download PPT
          </button>
        </div>
      </div>
      ...
      {/* This code is for Ai - when AI cannot generate chart, becuase "some" "topic" "cannot" require Charts  */}
