    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
        ...
        <p className="text-sm text-gray-300 max-w-sm">
            ExamNotes AI helps students to generate exam-focused notes, revision materials, diagrams, and printable PDFs using AI.
        </p>
...
{/* left footer */}
        <div className="text-center">
            ...
            <ul className="space-y-2 text-sm">
                <li className="text-red-400 hover:text-red-300 transition-colors cursor-pointer" onClick={() => handleSignOut()}>
                    SignOut
                </li>
